...
// export async function create<T>(model: Model<T>, dto, options: SaveOptions, project: { __v: 0 }) {

//   const data = await model.create([dto], options);
//   console.log(data);

// }

// export async function updateById<T>(id, data) {
